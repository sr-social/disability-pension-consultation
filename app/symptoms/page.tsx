...
import EyeDisorders from './EyeDisorders';
import MentalDisorders from './MentalDisorders';
import LimbDisorders from './LimbDisorders';
import HearingDisorders from './HearingDisorders';
import InternalDisorders from './InternalDisorders';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16 sm:h-20">
            ...
            <nav className="hidden lg:flex items-center space-x-8">
              ...
              <Link href="/symptoms" className="text-orange-600 font-medium cursor-pointer">
                病名・症状別
              </Link>
      ...
      <section className="py-20 bg-orange-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-gray-800 mb-6">
            あなたの症状でも障害年金を受給できるかもしれません
          </h2>
          <p className="text-lg text-gray-600 mb-10">
            症状や病名について詳しくご相談いただけます。<br />
            まずはお気軽にお問い合わせください。
          </p>
          
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="bg-green-500 hover:bg-green-600 text-white px-10 py-4 rounded-full text-lg font-medium transition-colors whitespace-nowrap cursor-pointer flex items-center justify-center">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <div className="space-y-3">
                <button className="w-full bg-green-500 hover:bg-green-600 text-white px-4 py-3 rounded-lg transition-colors whitespace-nowrap cursor-pointer flex items-center justify-center">
